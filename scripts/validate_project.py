...
def app_feature_checks(
    ...
    checks.append(require_text(brush_sticker_panel_text, "sizePreviewView.centerYAnchor.constraint(equalTo: shell.centerYAnchor", "Size controls keep a compact inline live preview without unsynchronized dot shortcuts (T114)"))
