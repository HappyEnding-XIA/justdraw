...
def app_feature_checks(
    ...
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.normalizedPressure", "Drawing canvas delegates to the Swift drawing bridge"))
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.normalizedPressure", "Pressure normalization is bridged to Swift"))
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.floodFillImage", "Flood fill is bridged to Swift"))
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.sampleColorFromImage", "Color sampling is bridged to Swift"))
    ...
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.crayonGrainDashPoints(pathBounds:", "Crayon grain geometry is delegated to the Swift bridge"))
    ...
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.floodFillImage", "Flood fill delegates to the Swift bridge"))
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.normalizedPressure", "Pressure normalization delegates to the Swift bridge"))
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.sampleColorFromImage", "Color sampling delegates to the Swift bridge"))
    ...
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.stickerTransformByClampingScale", "Sticker scale constraint is delegated to the Swift bridge"))
    checks.append(require_text(canvas_text, "KCDrawingEngineAdapter.clampStickerCenter", "Sticker center constraint is delegated to the Swift bridge"))
    ...
    checks.append(require_text(main_text, "KCDrawingEngineAdapter.historyMaxPageIndex(sessionCount:", "Controller delegates history max-page to the Swift Feature model"))
    checks.append(require_text(main_text, "KCDrawingEngineAdapter.historySessionIndex(", "Controller delegates thumbnail→session mapping to the Swift Feature model"))
    checks.append(require_text(main_text, "KCDrawingEngineAdapter.historyClampedPageIndex(", "Controller delegates history page clamping to the Swift Feature model"))
    return checks
