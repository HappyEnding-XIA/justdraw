...
def app_feature_checks(
    ...
    checks.append(require_regex(main_text, r"func buildLeftRail[\s\S]*toolScrollView\.showsVerticalScrollIndicator = self\.isCompactPhoneLayout[\s\S]*toolScrollView\.indicatorStyle = \.black", "Compact iPhone left rail shows a scroll indicator so hidden tools are discoverable"))
