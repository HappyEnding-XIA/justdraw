...
def app_feature_checks(
    ...
    checks.append(require_text(brush_dock_feature_text, "activeBackgroundColor", "Brush Dock selected background color is centralized"))
    checks.append(require_text(brush_dock_feature_text, "inactiveBorderColor", "Brush Dock inactive border color is centralized"))
