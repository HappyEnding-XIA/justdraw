...
- T116 画笔交互性能与蜡笔稳定：`brush-interaction` 在 iPhone 17 Pro / iPad Pro 11 M4 上验证 600 采样增量比例、追加批次 P95/最大耗时、300 条历史笔画 viewport replay/rebuild 计数、蜡笔偏移/纵横比/有限几何；双端自动化通过。iPad Pro 11 M4 模拟器观测约 22.7 FPS，不替代老款实体 iPad 的 30 FPS 真机验收。
