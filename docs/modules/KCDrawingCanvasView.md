...
- 当前自动化证据（2026-07-21，最终代码）：iPhone 17 Pro 增量比例 `0.02930`、追加 P95 `0.01204ms`、最大 `0.01609ms`、平均 `189.75 FPS`、最大帧 `7.00ms`；iPad Pro 11 M4 增量比例 `0.02770`、追加 P95 `0.01299ms`、最大 `0.03397ms`、平均 `82.28 FPS`、最大帧 `15.10ms`、preview 预热 `16.27ms`。
